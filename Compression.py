...
if h == 1:
    ...
    print("Invalid input!!!")                    # taking user input
...
print("Your original file size was", uncompressed_file_size,"bits. The compressed file size is:",compressed_file_size)
print("This is a saving of ",uncompressed_file_size-compressed_file_size,"bits")
print("Compression ratio is: ",(compressed_file_size/uncompressed_file_size)*100)
...
if h == 1:
    ...
    print(res)
    print("Observe the shapes and check whether input and output arrays are matching or not")
